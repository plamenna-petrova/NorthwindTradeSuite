...
namespace NorthwindTradeSuite.Persistence.Migrations
{
    ...
    [Migration("20240621144937_NonRequiredEmployeeManagerSameTableRelationship")]
    partial class NonRequiredEmployeeManagerSameTableRelationship
    {
            ...
            modelBuilder.Entity("NorthwindTradeSuite.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Employee_BirthDate", "CreatedAt IS NULL OR BirthDate < CreatedAt");
